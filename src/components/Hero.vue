    ...
    <section class="relative">
        <div class="container flex flex-col-reverse lg:flex-row items-center pag-12 mt-14 lg:mt-28">
            <div class="flex flex-1 flex-col items-center lg:items-start">
                <h2 class="text-white text-3xl md:text-4 leg:text-5xl text-center lg:text-left mb-6">Chill Chat</h2>
                <p class="text-bookmark-grey text-lg text-center lg:text-left mb-6">Your ChatBot AI Companion for Emotional Well-being.</p>
            ...
            <div class="flex justify-center flex-1 mb-10 md:mb-16 lg:mb-0 z-10">
                <img src="../assets/images/chillchat.png" alt="micro illustration"
